...
%     \item[I] Momento de Inercia Equivalente del robot, respecto del eje de rotación (eje vertical Z) de su primeraa articulación.
...
%     \item ['\textbf{foh}':] Retención de primera Orden (siglas del inglés: first-order hold) o Aproximación Triangular.
...
% De esta expasión, solo se toman los dos primeraos términos para obtener la aproximación lineal de primera orden de Z:
...
% Con lo que, tomando como aproximación solo los primeraos dos términos de las series, se obtiene la ecuación \ref{eq:Transformación Bilineal Inversa} de la transformación bilineal inversa utilizada en el método de Tustin:

% \begin{align}   \label{eq:Transformación Bilineal Inversa Demostrada}
%     Z \approx \frac{1+\frac{S.T}{2}}{1-\frac{S.T}{2}}
% \end{align}

% La cual es una mejor aproximación de primera orden que \ref{eq:Aproximación Lineal de Z}.
